...
<title>ADITYA TIWARI || TEST YOUR SKILL </title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Skill Tester</span></div>
...
echo '<tr style="color:#66CCFF"><td>Total Questions</td><td>'.$qa.'</td></tr>
	...
	//  <tr style="color:#66CCFF"><td>responce&nbsp;<span class="glyphicon glyphicon-star" aria-hidden="true"></span></td><td>'.$zz.'</td></tr>';
